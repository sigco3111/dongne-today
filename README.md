...
토스 앱 안에서 실행되는 미니앱으로, 사용자의 현재 동네에 대한 **오늘의 컨디션(날씨·미세먼지·강수확률·공휴일·동네 비교)**을 인포그래픽 대시보드로 보여주고, **MBTI 캐릭터형 한 줄 리포트**로 동네 성격을 표현해요.
...
| 3 | 🌧️ **강수확률/강수량** (24시간 hourly) | 라인 차트 | Open-Meteo (무키) |
